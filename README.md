...
<!-- YOUTUBE:START -->
- [Библиотека Pygame. Базовые элементы визуального оформления. Геометрические примитивы | Pygame](https://www.youtube.com/watch?v=f784MuNkeaI)
- [Библиотека Pygame. Обзор, установка, шаблон проекта | Pygame](https://www.youtube.com/watch?v=F6uWUmL9ItA)
